				...
				>
					<Stack maxW={'2xl'} align={'flex-start'} spacing={6}>
						...
						<Text textColor='white' fontWeight='medium' fontSize='lg'>
							Turn your passion for impact into tangible action for
							environmental change. Calculate your project&apos;s carbon
							footprint and offset it directly with tokenized carbon credits.
						</Text>
						<Link href='/calculator'>
							<Button bg={'#DEFE75'} color={'black'} _hover={{ bg: '#cdde99' }}>
