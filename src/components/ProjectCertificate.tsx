    ...
    <>
      <VStack gap="0" align="start" mt='8'>
        <HStack width="100%">
          ...
          <Spacer />
          <Text fontWeight="semibold" fontSize="lg" textColor="gray.500" mb="2">{`${sliderValueCertified}%`}</Text>
        </HStack>
        <Progress size='md' value={sliderValueCertified} w="100%" borderRadius="lg" />
      </VStack>
    </>
  )
}
