	...
	return (
		<div>
			...
			<Flex mt='2%' flexDirection={{ base: 'column', md: 'row' }}>
				<FormControl mr='2%'>
					<FormLabel
						htmlFor='peopleByPublicTransport'
						textColor='gray.500'
						fontWeight='medium'
						fontSize='md'
					>
				...
				<FormControl mr='2%'>
					<FormLabel
						htmlFor='distanceByPublicTransport'
						textColor='gray.500'
						fontWeight='medium'
						fontSize='md'
					>
			...
			<Flex mt='2%' flexDirection={{ base: 'column', md: 'row' }}>
				...
				<FormControl mr='2%'>
					<FormLabel
						htmlFor='percentageBusinessClass'
						textColor='gray.500'
						fontWeight='medium'
						fontSize='md'
					>
